...
public abstract class AbstractMongoDatabase implements MongoDatabase {
    ...
    public AbstractMongoDatabase(String databaseName, MongoBackend backend) throws MongoServerException {
        this.databaseName = databaseName;
        this.backend = backend;
        this.namespaces = createNamespacesCollection(databaseName);
        this.collections.put(namespaces.getCollectionName(), namespaces);

        this.indexes = createIndexesCollection(databaseName);
    ...
    protected void addIndex(BSONObject indexDescription) throws MongoServerException {
        ...
        if (key.keySet().equals(Collections.singleton("_id"))) {
            ...
            collection.addIndex(createUniqueIndex("_id", ascending));
            ...
            collection.addIndex(createUniqueIndex(field, ascending));
        } else {
